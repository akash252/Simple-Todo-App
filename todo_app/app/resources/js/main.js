...
//  remove and complete icons in svg format
	...
	// if there's any text inside the item field, add that text to the todo list
...
// adds a new item to the todo list
	function addItemtoDo(text){
		...
		// add click event listener for removing an item
		...
		// add click event listener for adding the item to completed list
